...
Page({                                                  // page项
    ...
    onLoad: function (options) {
        ...
        console.log("login.onLoad loginValue:",loginValue);
    ...
    loginFn: function () {     // 判断是否是登陆的状态
        ...
        wx.login({
            success: function (res) {
                console.log("login.loginFn res:",res);
                if (res.code) {
                    _this.setData({
                        code: res.code
                    })
        ...
        if (!!flag) {
            ...
            Utils.requestFn({
                ...
                success: function (res) {           // 成功、返回的数据
                    console.log("login.mysubmit res:",res);
    ...
    getPhoneRequest: function (iv, encryptedData, code) {    // 请求接口解密用户信息
        ...
        Utils.requestFn({
            ...
            success: function (res) {
                console.log('login getPhoneRequest suc res:',res);
                if (res.data.status) {
