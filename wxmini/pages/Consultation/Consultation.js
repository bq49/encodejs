...
Page({
    ...
    coordinate() {   // 页面初始的时候请求位置
        ...
        qqmapsdk.reverseGeocoder({
            complete: function (res) { // 获取位置成功返回
                // console.log("Consultation.coordinate reverseGeocoder res:",res);
                if (res.result) {
                    ...
                    */
                    try{
                        ...
                        var lv2 = address_component.ad_level_2;
                        var lv3 = address_component.ad_level_3;
    ...
    jumpFn(event) { // 点击进入详情
        ...
        // console.log('Consultation jumpFn DoId:'+DoId);
        var datas = "";
        var loginDatas = wx.getStorageSync("login");    // 获取登陆信息
        var loginJosn = {};
        var bool = event.currentTarget.dataset.bool;
        // console.log('Consultation bool:'+bool+" event:",event);
        if (bool) {
        ...
        Utils.requestFn({
            ...
            success: function (res) {
                // console.log('consultation.jumpFn res:',res);
                // 记录一下传入详情的值，为详情刷新做准备
                loginJosn = { id: DoId }
    ...
    defaultMore() {// 获取更多案例接口的数据
        ...
        Utils.requestFn({
            ...
            success(res) {
                console.log('Consultation.defaultMore:',res);
                let record = res.data;
    ...
    defaultRequestFn({ name = '', id = 1, page = 1 } = {}) {
        ...
        Utils.requestFn({
            ...
            success: function (res) {
                console.log("Consultation.defaultRequestFn res:",res);
    ...
    oneReqLoads() {           // 初次加载默认的数据
        ...
        Utils.requestFn({
            ...
            success: function (res) {
                // console.log("Consultation.oneReqLoads res:",res);
