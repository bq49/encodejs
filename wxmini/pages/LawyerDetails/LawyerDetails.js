...
Page({
    ...
    onShow() {
        ...
        Utils.requestFn({
            ...
            data: josn,
            success(res) {
                console.log('LawyerDetails onShow res:',res);
                let rData = res.data;
                if (rData.status) {
    ...
    againDta() {     // 关注请求数据
        ...
        if (!!getVal.openid) {
            Utils.requestFn({
                ...
                success(res) {
                    console.log('LawyerDetails againDta res:',res);
                    if (!res.data.status) {
    ...
    setRequest() {    // 请求律师详情的接口刷新本地存储的数据
        ...
        let load = new Promise(function (resolve, reject) {
            Utils.requestFn({
                ...
                data: josn,
                success(res) {
                    console.log("LawyerDetails setRequest res:",res);
                    let rData = res.data;
                    if (rData.status) {
        ...
        if (need) {     // 如果已经购买了 那么就不请求接口直接拨打电话
            ...
            if (!res.openid) {
                ...
                Utils.requestFn({
                    ...
                    data: josn,
                    success(res) {
                        console.log('LawyerDetails Consultation res:',res);
    ...
    MoreData() {   // 请求更多评价接口
        ...
        let promise = new Promise((resolve, reject) => {
            Utils.requestFn({
                ...
                data: { attid: attid },
                success(res) {
                    console.log('LawyerDetails MoreData res:',res);
